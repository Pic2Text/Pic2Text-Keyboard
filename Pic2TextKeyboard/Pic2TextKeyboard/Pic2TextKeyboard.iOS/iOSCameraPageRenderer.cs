...
using Foundation;
using UIKit;
using Pic2TextKeyboard;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;
using Pic2TextKeyboard.iOS;
...
namespace Pic2TextKeyboard.iOS
{
    public class CameraPageRenderer : PageRenderer
    {
        ...
        private void SetupEventHandlers()
        {
            ...
            {
                (Element as Pic2TextKeyboard.CameraPage).Cancel();
            };
            ...
            takePhotoButton.TouchUpInside += async (s, e) =>
            {
                ...
                (Element as Pic2TextKeyboard.CameraPage).SetPhotoResult(data.ToArray(),
